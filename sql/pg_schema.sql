...
--
-- Name: accesses; Type: TABLE; Schema: public; Owner: squid; Tablespace:
--
...
ALTER TABLE public.accesses OWNER TO squid;

--
-- Name: accesses_id_seq; Type: SEQUENCE; Schema: public; Owner: squid
--
...
ALTER TABLE public.accesses_id_seq OWNER TO squid;

--
-- Name: accesses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: squid
--
...
--
-- Name: http_requests; Type: TABLE; Schema: public; Owner: squid; Tablespace: 
--
...
ALTER TABLE public.http_requests OWNER TO squid;

--
-- Name: http_statuses; Type: TABLE; Schema: public; Owner: squid; Tablespace: 
--
...
ALTER TABLE public.http_statuses OWNER TO squid;

--
-- Name: id; Type: DEFAULT; Schema: public; Owner: squid
--
...
--
-- Data for Name: accesses; Type: TABLE DATA; Schema: public; Owner: squid
--

COPY accesses (id, "time", time_response, ip_source, ip_destination, user_name, http_status_code, http_reply_size, http_request_method, http_request_url, http_content_type, squid_hier_code, squid_request_status) FROM stdin;
\.


--
-- Name: accesses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: squid
--

SELECT pg_catalog.setval('accesses_id_seq', 1, true);


--
-- Data for Name: http_requests; Type: TABLE DATA; Schema: public; Owner: squid
--
...
--
-- Data for Name: http_statuses; Type: TABLE DATA; Schema: public; Owner: squid
--
...
--
-- Name: http_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: squid; Tablespace: 
--
...
--
-- Name: http_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: squid; Tablespace: 
--
...
--
-- Name: accesses_http_request_method_fkey; Type: FK CONSTRAINT; Schema: public; Owner: squid
--
...
--
-- Name: accesses_http_status_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: squid
--
...
--
-- Name: accesses; Type: ACL; Schema: public; Owner: squid
--

REVOKE ALL ON TABLE accesses FROM PUBLIC;
REVOKE ALL ON TABLE accesses FROM squid;
GRANT ALL ON TABLE accesses TO squid;
GRANT SELECT,INSERT,UPDATE ON TABLE accesses TO squid;


--
-- Name: accesses_id_seq; Type: ACL; Schema: public; Owner: squid
--

REVOKE ALL ON SEQUENCE accesses_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE accesses_id_seq FROM squid;
GRANT ALL ON SEQUENCE accesses_id_seq TO squid;
GRANT ALL ON SEQUENCE accesses_id_seq TO squid;
