...
== Installation
    ...
    I make gem when I provide logger support.
    (cd blooper && gem build blooper.gemspec && gem install blooper-1.1.gem)

== Squid configuration

1. The column names are dynamic, you should put it down into squid logformat.
...
2. Blooper configuration. This string contains database access information, and
