...
3. Third string is full path to executable ($ which blooper).
...
Or use your own schema integration, just specify proper format into the logformat variable in squid.conf.
